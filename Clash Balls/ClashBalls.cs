...
namespace RSCC_GEN.Clash_Balls
{
    public partial class ClashBalls : System.Windows.Forms.Form
    {
        ...
        ClashDetective parent;
        UIApplication uiapp;
        public IList<ClashPoint> points;

        public ClashBalls(ClashDetective parent, UIApplication uiapp, IList<Element> balls, bool vis)
        {
        ...
        public ClashBalls(ClashDetective parent, UIApplication uiapp, IList<ClashPoint> clashes, bool vis)
        {
            points = new List<ClashPoint>();
            this.uiapp = uiapp;
            this.uidoc = this.uiapp.ActiveUIDocument;
